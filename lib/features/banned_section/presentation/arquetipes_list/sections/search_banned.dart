...
//SearchBanned: widget to show the search banned
class SearchBanned extends ConsumerWidget {
  const SearchBanned(
    this.textController,
    this.controller,
    this.state, {
  ...
  final BannedListController controller;
  final BannedListState state;
